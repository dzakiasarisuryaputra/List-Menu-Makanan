...
public class MakananAdapter extends RecyclerView.Adapter<MakananAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull MakananAdapter.ViewHolder holder, int position) {
        ...
        holder.txtSebutan.setText(makanan.getSebutan());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                it.putExtra("sebutan",makanan.getSebutan());
    ...
    public class ViewHolder extends  RecyclerView.ViewHolder{
        ...
        public TextView txtNama,txtHarga,txtSebutan;
        ...
        public ViewHolder(@NonNull View itemView){
            ...
            txtSebutan =(TextView) itemView.findViewById(R.id.txtSebutan);
